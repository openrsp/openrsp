...
OpenRSP API: OpenRSPAddTwoOper
==============================
.. include:: background.rst

Similar to :ref:`slide-one-electron`, the two-electron operators will
be saved in a linked list in OpenRSP. Users can call the following API:
...
The arguments ``num_pert``, ``pert_labels`` and ``pert_max_orders`` are
