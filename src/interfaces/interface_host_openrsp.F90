module interface_host_openrsp

!  interface_host_openrsp_init is the ONLY routine
!  that is program specific
!  you are NOT allowed to introduce anything specific
!  to a host program outside of interface_host_openrsp_init

   implicit none

   public interface_host_openrsp_init
   public interface_host_openrsp_finalize
...
contains
   ...
   subroutine interface_host_openrsp_init()
...
#include "inforb.h"
   ...
   subroutine interface_host_openrsp_finalize()
!     here deallocate everything that is allocated
   ...
   subroutine check_if_interface_is_initialized()
      if (.not. is_initialized) then
         print *, 'error: you try to access interface_host_openrsp'
