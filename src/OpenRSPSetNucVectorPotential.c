...
*/
QErrorCode OpenRSPSetNucVectorPotential(OpenRSP *open_rsp,
                                        const QReal gauge_origin[3])
{
    ...
    ierr = RSPNucHamiltonSetVectorPotential(open_rsp->nuc_hamilton,
                                            gauge_origin);
    QErrorCheckCode(ierr, FILE_AND_LINE, "calling RSPNucHamiltonSetVectorPotential");
    return QSUCCESS;
}
