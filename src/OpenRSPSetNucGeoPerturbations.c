/* OpenRSP: open-ended library for response theory
   ...
   This file implements the function OpenRSPSetNucGeoPerturbations().
...
*/
QErrorCode OpenRSPSetNucGeoPerturbations(OpenRSP *open_rsp,
                                         ...
                                         const QReal *atom_charge)
{
    ...
    ierr = RSPNucHamiltonSetGeoPerturbations(open_rsp->nuc_hamilton,
                                             num_atoms,
                                             atom_coord,
                                             atom_charge);
    QErrorCheckCode(ierr, FILE_AND_LINE, "calling RSPNucHamiltonSetGeoPerturbations");
    return QSUCCESS;
}
