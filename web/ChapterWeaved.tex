...
\LA{}OpenRSPStruct~{\nwtagstyle{}\subpageref{NWImpz-OpeD-1}}\RA{}
...
\nwused{\\{NWImpz-Ope9-1}\\{NWImpz-OpeF-1}\\{NWImpz-OpeH-1}\\{NWImpz-OpeE.2-1}\\{NWImpz-OpeG-1}\\{NWRSP10-RSPH-1}\\{NWRSP10-RSPE-1}\\{NWRSP10-OpeP-1}\\{NWRSP10-RSPF.2-1}\\{NWRSP10-RSPH.3-1}\\{NWRSP10-RSPE.2-1}\\{NWRSP10-RSPL-1}\\{NWRSP10-RSPP-1}\\{NWRSP10-RSPG-1}\\{NWRSPv-OpeJ-1}\\{NWRSPv-RSPC-1}\\{NWRSPv-RSPI-1}\\{NWRSPv-RSPK-1}\\{NWRSPv-RSPH.5-1}\\{NWRSPv-RSPI.2-1}\\{NWRSPv-RSPI.3-1}\\{NWRSPv-RSPJ.2-1}\\{NWRSPv.2-OpeJ.2-1}\\{NWRSPv.2-RSPC.2-1}\\{NWRSPv.2-RSPI.4-1}\\{NWRSPv.2-RSPF.3-1}\\{NWRSPv.2-RSPK.2-1}\\{NWRSPv.2-RSPH.6-1}\\{NWRSPv.2-RSPI.5-1}\\{NWRSPv.2-RSPI.6-1}\\{NWRSPv.2-RSPJ.3-1}\\{NWRSPv.3-OpeJ.3-1}\\{NWRSPv.3-RSPC.3-1}\\{NWRSPv.3-RSPI.7-1}\\{NWRSPv.3-RSPF.4-1}\\{NWRSPv.3-RSPK.3-1}\\{NWRSPv.3-RSPH.7-1}\\{NWRSPv.3-RSPI.8-1}\\{NWRSPv.3-RSPI.9-1}\\{NWRSPv.3-RSPJ.4-1}\\{NWRSPt-OpeH.2-1}\\{NWRSPt-RSPA.2-1}\\{NWRSPt-RSPG.2-1}\\{NWRSPt-RSPD.2-1}\\{NWRSPt-RSPI.A-1}\\{NWRSPt-RSPF.5-1}\\{NWRSPt-RSPG.3-1}\\{NWRSPt-RSPG.4-1}\\{NWRSPt-RSPH.8-1}\\{NWRSPz-OpeN-1}\\{NWRSPz-RSPG.5-1}\\{NWRSPz-RSPM-1}\\{NWRSPz-RSPO-1}\\{NWRSPz-RSPL.2-1}\\{NWRSPz-RSPW-1}\\{NWRSPz-RSPR-1}\\{NWRSPz-RSPN-1}\\{NWRSPu-OpeR-1}\\{NWRSPu-RSPB-1}\\{NWRSPu-RSPH.9-1}\\{NWRSPu-RSPJ.5-1}\\{NWRSPu-RSPG.6-1}\\{NWRSPu-RSPV-1}\\{NWRSPu-RSPI.B-1}\\{NWRes12-OpeI-1}\\{NWRest-OpeJ.4-1}\\{NWForw-OpeN.2-1}}\nwendcode{}\nwbegindocs{4}In the following sections, we will describe how to implement each component
...
The \LibName context {\tt{}OpenRSPStruct} will encapsulate all the implemented C
{\tt{}struct}'s of the ``\LibName C support'' components into another C
{\tt{}struct}:
\nwenddocs{}\nwbegincode{5}\sublabel{NWImpz-OpeD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWImpz-OpeD-1}}}\moddef{OpenRSPStruct~{\nwtagstyle{}\subpageref{NWImpz-OpeD-1}}}\endmoddef
typedef struct \{
...
\nwenddocs{}\nwbegincode{13}\sublabel{NWImpz-OpeE.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWImpz-OpeE.2-1}}}\moddef{OpenRSPWrite.c~{\nwtagstyle{}\subpageref{NWImpz-OpeE.2-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\LA{}RSPPertBasicTypes~{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-1}}\RA{}

\LA{}RSPPertCallback~{\nwtagstyle{}\subpageref{NWRSP10-RSPF-1}}\RA{}

\LA{}RSPPertStruct~{\nwtagstyle{}\subpageref{NWRSP10-RSPD-1}}\RA{}

\LA{}RSPertAPIs~{\nwtagstyle{}\subpageref{NWRSP10-RSPA-1}}\RA{}

#endif
\nwnotused{RSPPerturbation.h}\nwendcode{}\nwbegindocs{2}\nwdocspar

The chunk {\tt{}RSPPertBasicTypes} defines some basic types used by \LibName for
...
{\tt{}QcPertInt}\index{{\tt{}QcPertInt}} is defined as follows:
\nwenddocs{}\nwbegincode{3}\sublabel{NWRSP10-RSPH.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-1}}}\moddef{RSPPertBasicTypes~{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-1}}}\endmoddef
...
#endif
\nwalsodefined{\\{NWRSP10-RSPH.2-2}\\{NWRSP10-RSPH.2-3}}\nwused{\\{NWRSP10-RSPH-1}}\nwendcode{}\nwbegindocs{4}Here we allow users to choose either
{\tt{}unsigned\ short}\index{{\tt{}OPENRSP{\char95}PERT{\char95}SHORT{\char95}INT}},
{\tt{}unsigned\ int}\index{{\tt{}OPENRSP{\char95}PERT{\char95}INT}}, or {\tt{}unsigned\ long} for the
type {\tt{}QcPertInt}. We also define a constant
{\tt{}QCPERTINT{\char95}MAX}\index{{\tt{}QCPERTINT{\char95}MAX}} for the maximal value of an object
of the {\tt{}QcPertInt} type, and a format string
({\tt{}QCPERTINT{\char95}FMT}\index{{\tt{}QCPERTINT{\char95}FMT}}) of the {\tt{}QcPertInt} type.

We futher allow users to set the number of bits in an object of {\tt{}QcPertInt}
...
{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}BIT}\index{{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}BIT}} during building:
\nwenddocs{}\nwbegincode{5}\sublabel{NWRSP10-RSPH.2-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-2}}}\moddef{RSPPertBasicTypes~{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-1}}}\plusendmoddef
...
#endif
\nwendcode{}\nwbegindocs{6}and from which, and from the knowledge of {\tt{}QCPERTINT{\char95}MAX} we can compute
{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}MAX}\index{{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}MAX}} and
{\tt{}OPENRSP{\char95}NUM{\char95}FREQ{\char95}MAX}\index{{\tt{}OPENRSP{\char95}NUM{\char95}FREQ{\char95}MAX}}, which are the maximal
values of perturbation labels and the number of frequencies allowed:
\nwenddocs{}\nwbegincode{7}\sublabel{NWRSP10-RSPH.2-3}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-3}}}\moddef{RSPPertBasicTypes~{\nwtagstyle{}\subpageref{NWRSP10-RSPH.2-1}}}\plusendmoddef
...
\nwendcode{}\nwbegindocs{8}Here, to avoid multiple inclusions of the header file that will lead to
multiple definitions, we have the following implementation file for the
{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}MAX} and {\tt{}OPENRSP{\char95}NUM{\char95}FREQ{\char95}MAX}:
\nwenddocs{}\nwbegincode{9}\sublabel{NWRSP10-RSPE-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPE-1}}}\moddef{RSPPertLabel.c~{\nwtagstyle{}\subpageref{NWRSP10-RSPE-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPPertLabel.c}\nwendcode{}\nwbegindocs{10}The function {\tt{}RSPPertCheckLabelBit()} ensures that
{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}BIT} is not too large and there are still bits left for
the number of frequencies. One will have building error when compiling the
function {\tt{}RSPPertCheckLabelBit()} if {\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}BIT} is too large.

However, the function {\tt{}RSPPertCheckLabelBit()} can not guarantee the above
setting ({\tt{}QcPertInt} type and {\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}BIT}) is enough for
holding the host program's perturbation labels and the number of frequencies.
This will be checked against {\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}MAX} and
{\tt{}OPENRSP{\char95}NUM{\char95}FREQ{\char95}MAX} by \LibName when (i) setting the host program's
...
callback function {\tt{}get{\char95}pert{\char95}concatenation()} to get the ranks of components
...
\nwenddocs{}\nwbegincode{11}\sublabel{NWRSP10-RSPF-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPF-1}}}\moddef{RSPPertCallback~{\nwtagstyle{}\subpageref{NWRSP10-RSPF-1}}}\endmoddef
...
\nwenddocs{}\nwbegincode{13}\sublabel{NWRSP10-RSPD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPD-1}}}\moddef{RSPPertStruct~{\nwtagstyle{}\subpageref{NWRSP10-RSPD-1}}}\endmoddef
typedef struct \{
...
\} RSPPert;
\nwused{\\{NWRSP10-RSPH-1}}\nwendcode{}\nwbegindocs{14}and users can set the above information by the following API:
\index{{\tt{}OpenRSPSetPerturbations()}}
\nwenddocs{}\nwbegincode{15}\sublabel{NWRSP10-OpeP-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-OpeP-1}}}\moddef{OpenRSPSetPerturbations.c~{\nwtagstyle{}\subpageref{NWRSP10-OpeP-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
The APIs {\tt{}RSPPertCreate()} and {\tt{}RSPPertDestroy()} will respectively create
and destroy the content of the {\tt{}struct} {\tt{}RSPPert}. We have the following
APIs for the {\tt{}struct} {\tt{}RSPPert}:
\nwenddocs{}\nwbegincode{17}\sublabel{NWRSP10-RSPA-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPA-1}}}\moddef{RSPertAPIs~{\nwtagstyle{}\subpageref{NWRSP10-RSPA-1}}}\endmoddef
...
\nwused{\\{NWRSP10-RSPH-1}}\nwendcode{}\nwbegindocs{18}which are respectively implemented in the following different files:
\nwenddocs{}\nwbegincode{19}\sublabel{NWRSP10-RSPF.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPF.2-1}}}\moddef{RSPPertCreate.c~{\nwtagstyle{}\subpageref{NWRSP10-RSPF.2-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\{
    ...
    return QSUCCESS;
\}
\nwnotused{RSPPertCreate.c}\nwendcode{}\nwbegindocs{20}Here we check the number of perturbation labels and each label against
{\tt{}OPENRSP{\char95}PERT{\char95}LABEL{\char95}MAX}.

\nwenddocs{}\nwbegincode{21}\sublabel{NWRSP10-RSPH.3-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPH.3-1}}}\moddef{RSPPertAssemble.c~{\nwtagstyle{}\subpageref{NWRSP10-RSPH.3-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPPertAssemble.c}\nwendcode{}\nwbegincode{22}\sublabel{NWRSP10-RSPE.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSP10-RSPE.2-1}}}\moddef{RSPPertWrite.c~{\nwtagstyle{}\subpageref{NWRSP10-RSPE.2-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\LA{}RSPOverlapContext~{\nwtagstyle{}\subpageref{NWRSPv-RSPH.4-1}}\RA{}
...
\nwenddocs{}\nwbegincode{5}\sublabel{NWRSPv-RSPH.4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv-RSPH.4-1}}}\moddef{RSPOverlapContext~{\nwtagstyle{}\subpageref{NWRSPv-RSPH.4-1}}}\endmoddef
typedef struct \{
...
\nwnotused{RSPOverlapAssemble.c}\nwendcode{}\nwbegincode{11}\sublabel{NWRSPv-RSPH.5-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv-RSPH.5-1}}}\moddef{RSPOverlapWrite.c~{\nwtagstyle{}\subpageref{NWRSPv-RSPH.5-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPOneOperCreate.c}\nwendcode{}\nwbegincode{6}\sublabel{NWRSPv.2-RSPF.3-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv.2-RSPF.3-1}}}\moddef{RSPOneOperAdd.c~{\nwtagstyle{}\subpageref{NWRSPv.2-RSPF.3-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPOneOperAssemble.c}\nwendcode{}\nwbegincode{8}\sublabel{NWRSPv.2-RSPH.6-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv.2-RSPH.6-1}}}\moddef{RSPOneOperWrite.c~{\nwtagstyle{}\subpageref{NWRSPv.2-RSPH.6-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPTwoOperCreate.c}\nwendcode{}\nwbegincode{6}\sublabel{NWRSPv.3-RSPF.4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv.3-RSPF.4-1}}}\moddef{RSPTwoOperAdd.c~{\nwtagstyle{}\subpageref{NWRSPv.3-RSPF.4-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPTwoOperAssemble.c}\nwendcode{}\nwbegincode{8}\sublabel{NWRSPv.3-RSPH.7-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPv.3-RSPH.7-1}}}\moddef{RSPTwoOperWrite.c~{\nwtagstyle{}\subpageref{NWRSPv.3-RSPH.7-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwenddocs{}\nwbegincode{3}\sublabel{NWRSPt-RSPA.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPt-RSPA.2-1}}}\moddef{RSPXCFun.h~{\nwtagstyle{}\subpageref{NWRSPt-RSPA.2-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
...
\nwnotused{RSPXCFunCreate.c}\nwendcode{}\nwbegincode{6}\sublabel{NWRSPt-RSPD.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPt-RSPD.2-1}}}\moddef{RSPXCFunAdd.c~{\nwtagstyle{}\subpageref{NWRSPt-RSPD.2-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPXCFunAssemble.c}\nwendcode{}\nwbegincode{8}\sublabel{NWRSPt-RSPF.5-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPt-RSPF.5-1}}}\moddef{RSPXCFunWrite.c~{\nwtagstyle{}\subpageref{NWRSPt-RSPF.5-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwnotused{RSPXCFunGetExp.c}\nwendcode{}\nwbegincode{11}\sublabel{NWRSPt-RSPH.8-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPt-RSPH.8-1}}}\moddef{RSPXCFunDestroy.c~{\nwtagstyle{}\subpageref{NWRSPt-RSPH.8-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
The functions are implemented as follows:
\nwenddocs{}\nwbegincode{5}\sublabel{NWRSPu-RSPH.9-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWRSPu-RSPH.9-1}}}\moddef{RSPSolverCreate.c~{\nwtagstyle{}\subpageref{NWRSPu-RSPH.9-1}}}\endmoddef
/*
  \LA{}OpenRSPLicense~{\nwtagstyle{}\subpageref{NWImpz-OpeE-1}}\RA{}
*/
...
\nwused{\\{NWForw-OpeB.2-1}\\{NWForw-RSPB.2-1}\\{NWForw-RSPE.3-1}\\{NWForw-RSPE.4-1}\\{NWForw-RSPD.3-1}\\{NWForw-RSPC.4-1}\\{NWForw-RSPI.C-1}\\{NWForw-RSPD.4-1}}\nwendcode{}\nwbegindocs{2}Here is the organization of the module file:
...
\nwnotused{RSPPert.F90}\nwendcode{}\nwbegincode{5}\sublabel{NWForw-RSPE.3-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWForw-RSPE.3-1}}}\moddef{RSPOverlap.F90~{\nwtagstyle{}\subpageref{NWForw-RSPE.3-1}}}\endmoddef
\LA{}OpenRSPLicenseFortran~{\nwtagstyle{}\subpageref{NWForw-OpeL-1}}\RA{}
...
\nwnotused{RSPOverlap.F90}\nwendcode{}\nwbegincode{6}\sublabel{NWForw-RSPE.4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWForw-RSPE.4-1}}}\moddef{RSPOneOper.F90~{\nwtagstyle{}\subpageref{NWForw-RSPE.4-1}}}\endmoddef
\LA{}OpenRSPLicenseFortran~{\nwtagstyle{}\subpageref{NWForw-OpeL-1}}\RA{}
...
\nwnotused{RSPOneOper.F90}\nwendcode{}\nwbegincode{7}\sublabel{NWForw-RSPD.3-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWForw-RSPD.3-1}}}\moddef{RSPTwoper.F90~{\nwtagstyle{}\subpageref{NWForw-RSPD.3-1}}}\endmoddef
\LA{}OpenRSPLicenseFortran~{\nwtagstyle{}\subpageref{NWForw-OpeL-1}}\RA{}
...
\nwnotused{RSPNucHamilton.F90}\nwendcode{}\nwbegincode{10}\sublabel{NWForw-RSPD.4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWForw-RSPD.4-1}}}\moddef{RSPSolver.F90~{\nwtagstyle{}\subpageref{NWForw-RSPD.4-1}}}\endmoddef
\LA{}OpenRSPLicenseFortran~{\nwtagstyle{}\subpageref{NWForw-OpeL-1}}\RA{}
...
\nwixlogsorted{c}{{OpenRSPStruct}{NWImpz-OpeD-1}{\nwixu{NWImpz-Ope9-1}\nwixd{NWImpz-OpeD-1}}}%
\nwixlogsorted{c}{{OpenRSPWrite.c}{NWImpz-OpeE.2-1}{\nwixd{NWImpz-OpeE.2-1}}}%
...
\nwixlogsorted{c}{{RSPOneOperAdd.c}{NWRSPv.2-RSPF.3-1}{\nwixd{NWRSPv.2-RSPF.3-1}}}%
...
\nwixlogsorted{c}{{RSPOneOper.F90}{NWForw-RSPE.4-1}{\nwixd{NWForw-RSPE.4-1}}}%
...
\nwixlogsorted{c}{{RSPOverlapWrite.c}{NWRSPv-RSPH.5-1}{\nwixd{NWRSPv-RSPH.5-1}}}%
\nwixlogsorted{c}{{RSPOverlap.h}{NWRSPv-RSPC-1}{\nwixd{NWRSPv-RSPC-1}}}%
\nwixlogsorted{c}{{RSPPertAssemble.c}{NWRSP10-RSPH.3-1}{\nwixd{NWRSP10-RSPH.3-1}}}%
\nwixlogsorted{c}{{RSPPertBasicTypes}{NWRSP10-RSPH.2-1}{\nwixu{NWRSP10-RSPH-1}\nwixd{NWRSP10-RSPH.2-1}\nwixd{NWRSP10-RSPH.2-2}\nwixd{NWRSP10-RSPH.2-3}}}%
\nwixlogsorted{c}{{RSPPertCallback}{NWRSP10-RSPF-1}{\nwixu{NWRSP10-RSPH-1}\nwixd{NWRSP10-RSPF-1}}}%
\nwixlogsorted{c}{{RSPPertCreate.c}{NWRSP10-RSPF.2-1}{\nwixd{NWRSP10-RSPF.2-1}}}%
...
\nwixlogsorted{c}{{RSPPertLabel.c}{NWRSP10-RSPE-1}{\nwixd{NWRSP10-RSPE-1}}}%
\nwixlogsorted{c}{{RSPPertStruct}{NWRSP10-RSPD-1}{\nwixu{NWRSP10-RSPH-1}\nwixd{NWRSP10-RSPD-1}}}%
\nwixlogsorted{c}{{RSPPertWrite.c}{NWRSP10-RSPE.2-1}{\nwixd{NWRSP10-RSPE.2-1}}}%
\nwixlogsorted{c}{{RSPPerturbation.h}{NWRSP10-RSPH-1}{\nwixd{NWRSP10-RSPH-1}}}%
\nwixlogsorted{c}{{RSPSolverAssemble.c}{NWRSPu-RSPJ.5-1}{\nwixd{NWRSPu-RSPJ.5-1}}}%
\nwixlogsorted{c}{{RSPSolverCreate.c}{NWRSPu-RSPH.9-1}{\nwixd{NWRSPu-RSPH.9-1}}}%
\nwixlogsorted{c}{{RSPSolverDestroy.c}{NWRSPu-RSPI.B-1}{\nwixd{NWRSPu-RSPI.B-1}}}%
\nwixlogsorted{c}{{RSPSolver.F90}{NWForw-RSPD.4-1}{\nwixd{NWForw-RSPD.4-1}}}%
...
\nwixlogsorted{c}{{RSPTwoOperAdd.c}{NWRSPv.3-RSPF.4-1}{\nwixd{NWRSPv.3-RSPF.4-1}}}%
...
\nwixlogsorted{c}{{RSPTwoOperWrite.c}{NWRSPv.3-RSPH.7-1}{\nwixd{NWRSPv.3-RSPH.7-1}}}%
\nwixlogsorted{c}{{RSPTwoOper.h}{NWRSPv.3-RSPC.3-1}{\nwixd{NWRSPv.3-RSPC.3-1}}}%
\nwixlogsorted{c}{{RSPTwoper.F90}{NWForw-RSPD.3-1}{\nwixd{NWForw-RSPD.3-1}}}%
\nwixlogsorted{c}{{RSPXCFunAdd.c}{NWRSPt-RSPD.2-1}{\nwixd{NWRSPt-RSPD.2-1}}}%
...
\nwixlogsorted{c}{{RSPXCFunDestroy.c}{NWRSPt-RSPH.8-1}{\nwixd{NWRSPt-RSPH.8-1}}}%
...
\nwixlogsorted{c}{{RSPXCFunWrite.c}{NWRSPt-RSPF.5-1}{\nwixd{NWRSPt-RSPF.5-1}}}%
\nwixlogsorted{c}{{RSPXCFun.h}{NWRSPt-RSPA.2-1}{\nwixd{NWRSPt-RSPA.2-1}}}%
\nwixlogsorted{c}{{RSPertAPIs}{NWRSP10-RSPA-1}{\nwixu{NWRSP10-RSPH-1}\nwixd{NWRSP10-RSPA-1}}}%
