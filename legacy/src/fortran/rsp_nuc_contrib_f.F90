...
!!
!!  This file implements subroutine of nuclear Hamiltonian used in the Fortran APIs.
!!
!!  2015-06-23, Bin Gao
!!  * first version
...
#define OPENRSP_API_SRC "src/f03/rsp_nuc_contrib_f.F90"

module rsp_nuc_contrib_f
